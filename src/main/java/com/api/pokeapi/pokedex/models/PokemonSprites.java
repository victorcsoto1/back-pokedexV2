...
public class PokemonSprites {
    ...
    private Map<String, Map<String, Object>> versions;
	...
	public Map<String, Map<String, Object>> getVersions() {
		return versions;
	}
	public void setVersions(Map<String, Map<String, Object>> versions) {
